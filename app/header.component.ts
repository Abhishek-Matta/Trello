...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
  ...
  <div id="wrap">
  <button class="btn btn-danger text-white " routerLink="/login"><i class="fas fa-sign-in-alt"></i> Log In</button>
    <button class="btn btn-warning ml-3 text-white" routerLink="signup"><i class="fas fa-user-plus"></i>  Sign Up</button>
    </div>
  </div>
</nav>
  `
