...
var Droppable = /** @class */ (function () {
    ...
    Droppable.prototype.drop = function (e) {
        ...
        this.allowDrop().subscribe(function (result) {
            if (result && _this._isDragActive) {
                ...
                _this.onDrop.emit(new drop_event_model_1.DropEvent(e, _this.ng2DragDropService.dragData, _this.ng2DragDropService.dragData2));
                _this.ng2DragDropService.dragData = null;
                _this.ng2DragDropService.dragData2 = null;
    ...
    Droppable.prototype.allowDrop = function () {
        ...
        if (typeof this.dropScope === 'string') {
            ...
            allowed = this.dropScope(this.ng2DragDropService.dragData,this.ng2DragDropService.dragData2);
